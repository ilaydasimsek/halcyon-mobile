...
import { TYogaLessonPracticeStep } from '../../model';

type TYogaLessonListItem = {
  lessonStep: TYogaLessonPracticeStep;
  completed: boolean;
  onPress: () => void;
};

const PracticeListItem: React.FC<TYogaLessonListItem> = ({
  lessonStep,
  completed,
  onPress,
}) => {
